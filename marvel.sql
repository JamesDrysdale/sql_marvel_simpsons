...
-- SELECT * FROM movies -- Task 1 complete
-- SELECT name FROM people -- Task 2 complete
-- UPDATE people SET name = 'Krusty the Clown' WHERE name = 'Crusty the Clown';  -- Task 3 complete
